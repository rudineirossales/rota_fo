<?php 
         ...
         if(!isset($_SESSION["login"]) &&  !isset($_SESSION["senha"])  )
            ...
            $sql = mysql_query ("select * from rota where id = '$id'" );
...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Editar Rotas</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
              ...
              <div class="row">
                  <div class="col-lg-6">
                    <form method="post"  action="enviar_edit.php ">

                    <input class="form-control"  id="exampleInputEmail1" value="<?php echo $id;?>" name="id"  type="hidden" aria-describedby="emailHelp" >
                          <div class="form-group">
                              <label for="exampleSelect1">Anuf</label>
                              <select class="form-control" id="exampleSelect1" name="anuf">
                                <option value="<?php echo $anuf;?>" ><?php echo $anuf;?></option>
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control"  id="exampleInputEmail1" value="<?php echo $trecho;?>" name="trecho"  type="text" aria-describedby="emailHelp" >
                      </div>
